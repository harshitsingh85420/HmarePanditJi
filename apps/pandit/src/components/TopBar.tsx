    ...
    >
      <div className="flex items-center gap-2">
        {showBack && (
          <button
            onClick={onBack}
            className="min-w-[48px] min-h-[48px] flex items-center justify-center text-white rounded-full active:bg-white/20 focus:ring-2 focus:ring-white focus:outline-none transition-colors"
      ...
      <button
        ...
        className="min-h-[48px] px-4 flex items-center gap-2 text-[16px] font-bold text-white active:opacity-70 focus:ring-2 focus:ring-white focus:outline-none border-2 border-white/50 rounded-full bg-white/10 backdrop-blur-sm transition-colors"
