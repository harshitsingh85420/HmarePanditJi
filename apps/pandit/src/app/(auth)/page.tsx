  ...
  return (
    <main className="splash-gradient shadow-2xl overflow-hidden min-h-dvh flex flex-col items-center relative w-full max-w-[390px] xs:max-w-[430px] mx-auto">
      ...
      <section className="flex flex-col items-center justify-center flex-grow -mt-8 xs:-mt-10 px-4">
        ...
        {/* Wordmark */}
        <h1 className="font-hind text-3xl xs:text-[36px] sm:text-[40px] font-[700] text-white tracking-[0.5px] leading-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">
          HmarePanditJi
        </h1>
        <h2 className="font-devanagari text-xl xs:text-[22px] sm:text-[26px] font-[500] text-white/80 mt-2 xs:mt-[8px] drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">
          हमारे पंडित जी
        </h2>
      </section>

      {/* Loading Area */}
      <footer className="absolute bottom-10 xs:bottom-[48px] w-full flex justify-center px-4">
        <div className="w-24 xs:w-28 sm:w-[120px] h-0.5 xs:h-[3px] bg-white/25 rounded-[2px] relative overflow-hidden">
          <motion.div
            initial={{ width: '0%' }}
            animate={{ width: '100%' }}
