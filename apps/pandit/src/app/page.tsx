...
export default function PanditHomeDashboard() {
  ...
  return (
    <div className="bg-[#f8f7f6] dark:bg-[#221910] font-display text-[#181411] dark:text-[#f8f7f6] min-h-screen">
      <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
        <div className="layout-container flex h-full grow flex-col">

          {/* Top Navigation Bar */}
          <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#f09942]/20 bg-white dark:bg-[#221910]/50 px-6 py-3 md:px-40 backdrop-blur-md sticky top-0 z-50">
            <div className="flex items-center gap-4 text-[#f09942]">
              ...
              <h2 className="text-[#181411] dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">HmarePanditJi</h2>
            </div>

            <div className="flex flex-1 justify-end gap-8 items-center">
              <nav className="hidden md:flex items-center gap-9">
                <Link className="text-[#f09942] text-sm font-bold leading-normal border-b-2 border-[#f09942] pb-1" href="/">Home</Link>
                <Link className="text-[#181411] dark:text-white/80 text-sm font-medium leading-normal hover:text-[#f09942] transition-colors" href="/bookings">Bookings</Link>
                <Link className="text-[#181411] dark:text-white/80 text-sm font-medium leading-normal hover:text-[#f09942] transition-colors" href="/travel">Travel</Link>
                <Link className="text-[#181411] dark:text-white/80 text-sm font-medium leading-normal hover:text-[#f09942] transition-colors" href="/earnings">Earnings</Link>
                <Link className="text-[#181411] dark:text-white/80 text-sm font-medium leading-normal hover:text-[#f09942] transition-colors" href="/profile">Profile</Link>
              </nav>

              <div className="flex items-center gap-3">
                <button className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#f09942]/10 text-[#181411] dark:text-white text-sm font-bold leading-normal tracking-[0.015em]">
                ...
                <div
                  ...
                  style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCDEy7eFlMpTU_m8vQtAhMBrP8B2fyV36yKgcdZJI2XyaSDK76Y2OekenHgQls2FJrlHOzRIe1sD-wwIZFO79kcw-6psGZiefiqHJecxrvQuMy1BsSNgQNbAMyWshPV2Wn5op7g4J3u7_r5K4ODRBb189nPvLgCW91zHjnDA6FJpAhIj3Ylync7F9L2tjPgy3PyU6rtM-HA7wKzwi4xLihz2vTEvkegIhnZFQDE7-uxcj5TLNBfHlCxLeD0bIhSGpcQMbAI0yGhKkY")' }}
                />
              </div>
            </div>
          </header>

          <main className="flex-1 max-w-[960px] mx-auto w-full px-4 pb-20 mt-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    {isOnline ? (
                      <span className="text-green-600 font-bold text-sm flex items-center gap-1">
                        <span className="size-2 rounded-full bg-green-600 animate-pulse"></span> ONLINE
                      </span>
                    ) : (
                      <span className="text-gray-500 font-bold text-sm flex items-center gap-1">
                        <span className="size-2 rounded-full bg-gray-500"></span> OFFLINE
                      </span>
                    )}
                  </div>
                  <label className="relative flex h-[31px] w-[51px] cursor-pointer items-center rounded-full border-none bg-gray-200 dark:bg-gray-700 p-0.5 has-[:checked]:justify-end has-[:checked]:bg-[#f09942] transition-all">
          ...
          <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[#221910] border-t border-gray-200 dark:border-gray-800 flex justify-around py-3 px-2 z-50">
            <Link className="flex flex-col items-center text-[#f09942]" href="/">
              <span className="material-symbols-outlined pb-1">home</span>
              <span className="text-[10px] font-bold">Home</span>
            </Link>
            <Link className="flex flex-col items-center text-gray-500 dark:text-gray-400" href="/bookings">
              <span className="material-symbols-outlined pb-1">event_note</span>
              <span className="text-[10px] font-medium">Bookings</span>
            </Link>
            <Link className="flex flex-col items-center text-gray-500 dark:text-gray-400" href="#">
              <span className="material-symbols-outlined pb-1">auto_stories</span>
              <span className="text-[10px] font-medium">Rituals</span>
            </Link>
            <Link className="flex flex-col items-center text-gray-500 dark:text-gray-400" href="/earnings">
              <span className="material-symbols-outlined pb-1">wallet</span>
              <span className="text-[10px] font-medium">Earnings</span>
            </Link>
            <Link className="flex flex-col items-center text-gray-500 dark:text-gray-400" href="/profile">
