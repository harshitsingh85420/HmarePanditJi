    ...
    <main className="w-full min-h-dvh max-w-[390px] xs:max-w-[430px] mx-auto bg-surface-base relative flex flex-col overflow-hidden shadow-2xl">
      ...
      <section className="px-4 xs:px-6 mb-3 xs:mb-4">
        <div
          ...
          className="bg-saffron-lt border-2 border-saffron rounded-2xl p-3 xs:p-4 flex items-center gap-3 xs:gap-4 cursor-pointer active:scale-[0.98] transition-transform"
        >
          ...
          {filteredLanguages.map((lang, idx) => {
            ...
            return (
              <motion.button
                ...
                className={`relative flex flex-col items-center justify-center min-h-[52px] xs:min-h-[56px] sm:min-h-[96px] rounded-xl px-3 xs:px-4 sm:px-5 transition-all ${isSelected
