  ...
  return (
    <TutorialShell currentDot={currentDot} onNext={onNext} onBack={onBack} onSkip={onSkip}>
      ...
      <div className="space-y-4 mb-6">
        {/* BEFORE Card */}
        <motion.article initial={{x:-20,opacity:0}} animate={{x:0,opacity:1}} transition={{delay:0.1}}
        ...
        {/* AFTER Card */}
        <motion.article initial={{x:20,opacity:0}} animate={{x:0,opacity:1}} transition={{delay:0.25}}
          ...
          <div className="bg-white rounded-xl p-3 text-left border border-green-200 shadow-sm">
            <div className="flex justify-between items-center mb-1">
              <span className="font-bold text-vedic-brown">सत्यनारायण पूजा</span>
            </div>
            <div className="text-success font-bold text-lg">आपकी दक्षिणा: ₹2,100</div>
