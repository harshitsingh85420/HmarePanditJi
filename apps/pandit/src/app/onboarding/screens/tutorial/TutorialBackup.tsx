...
export default function TutorialBackup({
  ...
  const TITLE = isLatin ? 'Backup' : 'बैकअप'
  const SUBTITLE = isLatin ? 'Aamdani' : 'आमदनी'
  const DESCRIPTION = isLatin ? 'Jab aap busy hain ya uplambdh nahi, app doosre Pandit ji ko bhej dega. Aapki booking aapke saathi ko milegi aur aapko commission milega.' : 'जब आप व्यस्त हैं या उपलब्ध नहीं, app दूसरे पंडित जी को भेज देगा। आपकी बुकिंग आपके साथी को मिलेगी और आपको कमीशन मिलेगा।'
  ...
  const { voiceFlowState } = useSarvamVoiceFlow({
    language: 'Hindi',
    script: isLatin ? 'Jab aap busy hain ya uplambdh nahi, app doosre Pandit ji ko bhej dega. Aapki booking aapke saathi ko milegi aur aapko commission milega.' : 'जब आप व्यस्त हैं या उपलब्ध नहीं, app दूसरे पंडित जी को भेज देगा। आपकी बुकिंग आपके साथी को मिलेगी और आपको कमीशन मिलेगा।',
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      void speakWithSarvam({ text: isLatin ? 'Jab aap busy hain ya uplambdh nahi, app doosre Pandit ji ko bhej dega. Aapko commission bhi milega.' : 'जब आप व्यस्त हैं या उपलब्ध नहीं, app दूसरे पंडित जी को भेज देगा। आपको कमीशन भी मिलेगा।', languageCode: 'hi-IN' })
    }, 200)
