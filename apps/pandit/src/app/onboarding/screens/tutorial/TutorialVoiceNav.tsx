...
export default function TutorialVoiceNav({
  ...
  const TITLE = isLatin ? 'Awaaz se' : 'आवाज़ से'
  const SUBTITLE = isLatin ? 'Navigation' : 'नेविगेशन'
  const DESCRIPTION = isLatin ? 'Is app ko aap apni awaaz se chala sakte hain. Screen padhne ya button dabane ki zaroorat nahi. Bas boliye — app sunega aur samjhega.' : 'इस app को आप अपनी आवाज़ से चला सकते हैं। स्क्रीन पढ़ने या बटन दबाने की ज़रूरत नहीं। बस बोलें — app सुनेगा और समझेगा।'
  ...
  const { voiceFlowState } = useSarvamVoiceFlow({
    language: 'Hindi',
    script: isLatin ? 'Is app ko aap apni awaaz se chala sakte hain. Screen padhne ya button dabane ki zaroorat nahi. Bas boliye — app sunega aur samjhega.' : 'इस app को आप अपनी आवाज़ से चला सकते हैं। स्क्रीन पढ़ने या बटन दबाने की ज़रूरत नहीं। बस बोलें — app सुनेगा और समझेगा।',
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      void speakWithSarvam({ text: isLatin ? 'Is app ko aap apni awaaz se chala sakte hain. Bas boliye — app sunega aur samjhega.' : 'इस app को आप अपनी आवाज़ से चला सकते हैं। बस बोलें — app सुनेगा और समझेगा।', languageCode: 'hi-IN' })
    }, 200)
