...
export default function TutorialOnlineRevenue({
  ...
  const TITLE = isLatin ? 'Online' : 'ऑनलाइन'
  const SUBTITLE = isLatin ? 'Kamai' : 'कमाई'
  const DESCRIPTION = isLatin ? 'Ghar baithe online puja, paath aur seva karein. Door baithe bhakt aapki seva book karenge. Har mahine extra aamdani ka sadhan.' : 'घर बैठे ऑनलाइन पूजा, पाठ और सेवा करें। दूर बैठे भक्त आपकी सेवा बुक करेंगे। हर महीने एक्स्ट्रा आमदनी का साधन।'
  ...
  const { voiceFlowState } = useSarvamVoiceFlow({
    language: 'Hindi',
    script: isLatin ? 'Ghar baithe online puja, paath aur seva karein. Door baithe bhakt aapki seva book karenge. Har mahine extra aamdani ka sadhan.' : 'घर बैठे ऑनलाइन पूजा, पाठ और सेवा करें। दूर बैठे भक्त आपकी सेवा बुक करेंगे। हर महीने एक्स्ट्रा आमदनी का साधन।',
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      void speakWithSarvam({ text: isLatin ? 'Ghar baithe online puja, paath aur seva karein. Door baithe bhakt aapki seva book karenge.' : 'घर बैठे ऑनलाइन पूजा, पाठ और सेवा करें। दूर बैठे भक्त आपकी सेवा बुक करेंगे।', languageCode: 'hi-IN' })
    }, 200)
