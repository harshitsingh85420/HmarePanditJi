...
export default function TutorialVideoVerify({
  ...
  const TITLE = isLatin ? 'Video' : 'वीडियो'
  const SUBTITLE = isLatin ? 'Satyapan' : 'सत्यापन'
  const DESCRIPTION = isLatin ? 'Registration ke baad chhota sa video satyapan hoga. Isse bhakt ko bharosa milta hai ki ve asli Pandit ji se seva le rahe hain. Bahut aasan prakriya hai.' : 'रजिस्ट्रेशन के बाद छोटा सा वीडियो सत्यापन होगा। इससे भक्त को भरोसा मिलता है कि वे असली पंडित जी से सेवा ले रहे हैं। बहुत आसान प्रक्रिया है।'
  ...
  const { voiceFlowState } = useSarvamVoiceFlow({
    language: 'Hindi',
    script: isLatin ? 'Registration ke baad chhota sa video satyapan hoga. Isse bhakt ko bharosa milta hai. Bahut aasan prakriya hai.' : 'रजिस्ट्रेशन के बाद छोटा सा वीडियो सत्यापन होगा। इससे भक्त को भरोसा मिलता है। बहुत आसान प्रक्रिया है।',
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      void speakWithSarvam({ text: isLatin ? 'Registration ke baad chhota sa video satyapan hoga. Bahut aasan prakriya hai.' : 'रजिस्ट्रेशन के बाद छोटा सा वीडियो सत्यापन होगा। बहुत आसान प्रक्रिया है।', languageCode: 'hi-IN' })
    }, 200)
