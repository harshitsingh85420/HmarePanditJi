...
export default function TutorialTravel({
  ...
  const TITLE = isLatin ? 'Yatra ki' : 'यात्रा की'
  const SUBTITLE = isLatin ? 'Vyavastha' : 'व्यवस्था'
  const DESCRIPTION = isLatin ? 'Door jaana ho to app travel aur thehrne ki vyavastha karega. Aapko bas jaakar seva karni hai — baaki sab app sambhalega.' : 'दूर जाना हो तो app यात्रा और ठहरने की व्यवस्था करेगा। आपको बस जाकर सेवा करनी है — बाकी सब app संभालेगा।'
  ...
  const { voiceFlowState } = useSarvamVoiceFlow({
    language: 'Hindi',
    script: isLatin ? 'Door jaana ho to app travel aur thehrne ki vyavastha karega. Aapko bas jaakar seva karni hai — baaki sab app sambhalega.' : 'दूर जाना हो तो app यात्रा और ठहरने की व्यवस्था करेगा। आपको बस जाकर सेवा करनी है — बाकी सब app संभालेगा।',
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      void speakWithSarvam({ text: isLatin ? 'Door jaana ho to app travel aur thehrne ki vyavastha karega. Baaki sab app sambhalega.' : 'दूर जाना हो तो app यात्रा और ठहरने की व्यवस्था करेगा। बाकी सब app संभालेगा।', languageCode: 'hi-IN' })
    }, 200)
