...
export default function TutorialTravel({ onNext, onSkip, onBack }: TutorialTravelProps) {
  ...
  const LINES = ['छुट्टियों पर शहर से बाहर जा रहे हैं?', 'यात्रा के दौरान भी कमाई करें।', 'रास्ते में पूजा बुक करें।', 'अतिरिक्त आमदनी का बेहतरीन मौका।', 'आगे बोलें।']
    ...
    <main className="w-full min-h-dvh max-w-[390px] xs:max-w-[430px] mx-auto bg-vedic-cream flex flex-col">
      ...
      <div className="flex-1 px-4 xs:px-6 py-6 xs:py-8 overflow-y-auto">
        <div className="text-center mb-6 xs:mb-8">
          ...
          <h1 className="text-xl xs:text-2xl sm:text-3xl font-bold text-vedic-brown mb-2 xs:mb-4">यात्रा के दौरान कमाई</h1>
        ...
        {showCards && (<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-saffron-lt border-2 border-saffron rounded-2xl p-4 xs:p-6 text-center"><div className="text-4xl xs:text-5xl mb-2">🗺️</div><p className="font-bold text-text-primary">रास्ते में पूजा बुक करें</p><p className="text-sm text-text-secondary mt-1">छुट्टी + कमाई, दोनो साथ</p></motion.div>)}
      </div>
