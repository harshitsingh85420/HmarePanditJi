...
export default function TutorialGuarantees({
  ...
  const TITLE = isLatin ? 'Chaaron' : 'चारों'
  const SUBTITLE = isLatin ? 'Vaade' : 'वादे'
  const DESCRIPTION = isLatin ? 'Chaaron waade — (1) Tay dakshina, (2) Turant bhugtan, (3) Yatra ki vyavastha, (4) Backup aamdani. Yeh hum aapse karte hain — aur nibhayenge.' : 'चारों वादे — (1) तय दक्षिणा, (2) तुरंत भुगतान, (3) यात्रा की व्यवस्था, (4) बैकअप आमदनी। यह हम आपसे करते हैं — और निभाएंगे।'
  ...
  const { voiceFlowState } = useSarvamVoiceFlow({
    language: 'Hindi',
    script: isLatin ? 'Chaaron vaade — tay dakshina, turant bhugtan, yatra ki vyavastha, aur backup aamdani. Yeh hum aapse karte hain — aur nibhayenge.' : 'चारों वादे — तय दक्षिणा, तुरंत भुगतान, यात्रा की व्यवस्था, और बैकअप आमदनी। यह हम आपसे करते हैं — और निभाएंगे।',
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      void speakWithSarvam({ text: isLatin ? 'Chaaron vaade — tay dakshina, turant bhugtan, yatra ki vyavastha, aur backup aamdani. Yeh hum nibhayenge.' : 'चारों वादे — तय दक्षिणा, तुरंत भुगतान, यात्रा की व्यवस्था, और बैकअप आमदनी। यह हम निभाएंगे।', languageCode: 'hi-IN' })
    }, 200)
