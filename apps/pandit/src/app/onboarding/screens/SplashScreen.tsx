...
export default function SplashScreen({ onComplete, onExit }: SplashScreenProps) {
  ...
  return (
    <main className="splash-gradient shadow-2xl overflow-hidden min-h-dvh flex flex-col items-center relative w-full">
      ...
      <section className="flex flex-col items-center justify-center flex-grow -mt-8 xs:-mt-10">
        {/* OM Symbol - ACC-010 FIX: Larger Om symbol for elderly visibility */}
        ...
        {/* Wordmark - ACC-010 FIX: Larger text with drop-shadow for elderly visibility */}
      ...
      {/* Loading Area */}
      <footer className="absolute bottom-10 xs:bottom-[48px] w-full flex justify-center">
