  ...
  return (
    <main className="splash-gradient shadow-2xl overflow-hidden min-h-dvh flex flex-col items-center relative w-full">
      ...
      {onExit && (
        <button
          onClick={onExit}
          className="absolute top-4 right-4 min-w-[56px] min-h-[56px] flex items-center justify-center text-white/80 hover:text-white active:opacity-50 z-50 focus:ring-2 focus:ring-white/50 focus:outline-none"
          aria-label="Exit app"
        >
