...
export default function HelpScreen({ language, onLanguageChange, onBack }: HelpScreenProps) {
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      speak('Koi baat nahi. Humari team se baat karein. Bilkul free hai.', bcp47)
    }, 500)
  ...
  return (
    <div className="min-h-screen bg-[#FFFBF5] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center px-6 pt-6 gap-6">
        {/* Illustration */}
        <div className="flex items-center justify-center w-[140px] h-[140px] rounded-full bg-[#FEF3C7]">
        ...
        <button
          ...
          className="w-full h-[72px] bg-[#F09942] rounded-[16px] shadow-[0_4px_12px_rgba(240,153,66,0.35)] flex items-center px-5 gap-4"
        >
        ...
        <button
          ...
          className="w-full h-[64px] rounded-[16px] flex items-center px-5 gap-4"
