...
export default function HelpScreen({ onLanguageChange, onBack }: HelpScreenProps) {
  ...
  return (
    <main className="w-full min-h-dvh max-w-[390px] mx-auto bg-vedic-cream text-vedic-brown font-hind flex flex-col shadow-2xl">
      ...
      <div className="flex flex-col items-center text-center px-6 flex-1">
        ...
        <div className="mt-8 mb-6 w-[140px] h-[140px] flex items-center justify-center bg-primary-lt rounded-full">
        ...
        <p className="text-[20px] text-vedic-gold font-medium mt-2">
        ...
        <section className="w-full space-y-3">
          ...
          <a
            href="tel:1800000000"
            className="flex items-center gap-4 bg-primary rounded-card shadow-cta px-5 py-0 min-h-[72px] active:scale-[0.98] transition-transform"
          >
        ...
        <div className="flex items-center gap-3 my-5 w-full">
          ...
          <span className="text-[15px] text-vedic-gold font-medium">─── या ───</span>
          <div className="flex-1 h-px bg-vedic-border" />
        </div>
        ...
        <button
          onClick={onBack}
          className="text-primary font-semibold border-b-2 border-primary-lt pb-0.5 hover:border-primary transition-colors text-[16px]"
        >
          वापस जाएं / खुद करें
        </button>
      </div>
      ...
      <footer className="text-center pb-8 pt-4">
        <p className="text-[14px] text-vedic-gold">
