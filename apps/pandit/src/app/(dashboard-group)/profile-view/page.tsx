    ...
    <div className="min-h-screen bg-cream text-ink pb-28">
      ...
      <main className="max-w-[430px] mx-auto px-4 pt-4 flex flex-col gap-4 page-enter">
        ...
        <Card className="p-5 bg-white border border-saffron-100 flex flex-col gap-3">
          <h3 className="text-[18px] font-bold text-temple-600 font-hindi">{hi.profileView.pujas}</h3>
        ...
        {/* दक्षिणा table */}
        <Card className="p-5 bg-white border border-saffron-100 flex flex-col gap-3">
          <h3 className="text-[18px] font-bold text-temple-600 font-hindi">{hi.profileView.dakshina}</h3>
          {dakshina.length === 0 ? (
            <span className="t-hint text-softgrey font-hindi">—</span>
          ) : (
