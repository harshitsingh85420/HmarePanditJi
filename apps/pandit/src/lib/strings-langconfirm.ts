...
export const LANG_CONFIRM: Record<LangCode, LangConfirmStrings> = {
  ...
  mr: {
    confirmQuestion: "आपल्याला मराठीत बोलायला आवडेल का?",
    yesLabel: "हो, मराठी चालेल",
    otherLabel: "दुसरी भाषा निवडावी",
    waitLine: "एक क्षण थांबावे…",
  ...
  gu: {
    confirmQuestion: "શું આપ ગુજરાતીમાં વાત કરવા માંગો છો?",
  ...
  pa: {
    confirmQuestion: "ਕੀ ਤੁਸੀਂ ਪੰਜਾਬੀ ਵਿੱਚ ਗੱਲ ਕਰਨਾ ਚਾਹੋਗੇ ਜੀ?",
    yesLabel: "ਹਾਂ, ਪੰਜਾਬੀ ਠੀਕ ਹੈ",
    otherLabel: "ਹੋਰ ਭਾਸ਼ਾ ਚੁਣੋ ਜੀ",
    waitLine: "ਇੱਕ ਪਲ ਜੀ…",
    confirmedLine: "ਵਧੀਆ ਜੀ! ਹੁਣ ਅਸੀਂ ਪੰਜਾਬੀ ਵਿੱਚ ਗੱਲ ਕਰਾਂਗੇ।",
    fallbackNotice: "ਅਨੁਵਾਦ ਹੁਣੇ ਉਪਲਬਧ ਨਹੀਂ ਜੀ — ਅਸੀਂ ਹਿੰਦੀ ਵਿੱਚ ਜਾਰੀ ਰੱਖਾਂਗੇ।",
  },
  ml: {
    confirmQuestion: "താങ്കൾ മലയാളത്തിൽ സംസാരിക്കാൻ ആഗ്രഹിക്കുന്നുവോ?",
    yesLabel: "അതെ, മലയാളം മതി",
    otherLabel: "മറ്റൊരു ഭാഷ തിരഞ്ഞെടുക്കുക",
    waitLine: "ഒരു നിമിഷം…",
    confirmedLine: "വളരെ സന്തോഷം! ഇനി നമുക്ക് മലയാളത്തിൽ സംസാരിക്കാം.",
  ...
  en: {
    ...
    otherLabel: "Please choose another language",
    waitLine: "One moment, please…",
    confirmedLine: "Certainly! We will continue in English.",
