...
export const TUTORIAL_TRANSLATIONS: Record<TutorialLanguage, TutorialTranslations> = {
  Hindi: {
    // canon frame 5a-5f skip affordance "छोड़ें ›" → register "छोड़िए ›"
    skip: 'छोड़िए ›',
    back: 'वापस जाइए',
    next: 'आगे',
    screens: {
      ...
      S07: {
        ...
        subtitle: 'बोलिए → लिखाई हो जाती है',
        demoText: 'हाँ या नहीं बोलकर देखिए',
        cta: 'अगला फ़ायदा देखिए →',
        voiceBadge: 'हाँ',
        speakTypes: 'बोलिए → लिखाई हो जाती है',
      ...
      S11: {
        ...
        cta: 'Registration शुरू कीजिए →',
      },
      S12: {
        title: 'Registration शुरू कीजिए?',
        subtitle: 'बिल्कुल मुफ़्त। 10 मिनट लगेंगे।',
        cta: '✅ हाँ, Registration शुरू कीजिए →',
        later: 'बाद में करूँगा',
        progressBadge: '✓ Tutorial पूरा हुआ',
        voicePrompt: "'हाँ' बोलिए या बटन दबाइए",
  ...
  Telugu: {
    ...
    screens: {
      ...
      S12: {
        ...
        progressBadge: '2/2',
        voicePrompt: 'హాన్ లేదా నహీ అని చెప్పండి',
        helpQuestion: 'సహాయం కావాలా?',
        helpHours: 'సోమ-శని, 10-7',
      },
    },
  },
  Bengali: {
