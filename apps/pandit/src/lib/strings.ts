export const hi = {
  ...
  shishya: {
    ...
    faq: {
      ...
      bookingHow:
        "जब कोई परिवार आपको बुक करता है, हम आपको फ़ोन करते हैं; ऐप खुला हो तो घंटी भी बजती है और बुकिंग होम पर दिखती है — आप स्वीकार कीजिए, बस।",
      bookingRefuse:
      ...
      customerCancel:
        "ग्राहक के रद्द करने पर बुकिंग वाले हिस्से में तुरंत दिख जाता है, और हम आपको फ़ोन भी करते हैं; भुगतान से जुड़े नियम के लिए मदद से टीम से पूछ लीजिए।",
      calendarHoliday:
      ...
      videoVerify:
        "पूजा जोड़ते समय अपनी पूजा का दो मिनट का वीडियो दीजिए — यूट्यूब का लिंक डालिए, या व्हाट्सएप पर भेज दीजिए। हमारी टीम वही देखकर सत्यापन करती है।",
      aadhaarSafe:
      ...
      changeLanguage:
        "अभी यह ऐप पूरी तरह हिंदी में ही चलता है, पंडित जी। बाकी भाषाएँ जाँच के बाद खुलेंगी — तैयार होते ही मैं आपको बता दूँगा।",
      voiceOff:
  ...
  settingsScreen: {
    intro: "यह सेटिंग की स्क्रीन है। यहाँ से घंटी की आवाज़ बंद या चालू कीजिए, अपनी प्रोफ़ाइल और पूजाएँ देखिए, या मदद तक पहुँचिए। मुझे चुप कराना हो तो नीचे मुझ पर एक बार स्पर्श कीजिए।",
    ...
    soundDesc: "ऐप खुला होने पर नई बुकिंग और शुभ अवसरों पर मधुर घंटी बजेगी",
  ...
  empty: {
    ...
    todayNoBookingsHint: "ऑनलाइन रहिए — नई बुकिंग आते ही हम आपको फ़ोन करेंगे",
  ...
  faq: {
    ...
    items: [
      ...
      { g: "booking", q: "नई बुकिंग कैसे पता चलेगी?", a: "नई बुकिंग आते ही हम आपको फ़ोन करते हैं; ऐप खुला हो तो घंटी बजती है और बुकिंग वाले हिस्से में दिखती है। आप हाँ या ना, दोनों कह सकते हैं।" },
