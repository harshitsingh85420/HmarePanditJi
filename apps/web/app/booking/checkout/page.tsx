                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-3 border-2 border-[#f49d25]/20 bg-[#f49d25]/5 rounded-lg flex items-center justify-between gap-3">
                                <div className="flex-1">
                                    <div className="flex items-center gap-1">
                                        ...
                                        <span className="text-[10px] bg-[#f49d25] text-white px-1 rounded">SAFE</span>
                                    </div>
                                    <p className="text-[11px] text-[#8a7960]">Guaranteed replacement within 2 hrs if emergency</p>
                                    <p className="text-xs font-bold text-[#f49d25] mt-1">+ ₹9,999</p>
                                </div>
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input
                                        type="checkbox"
                                        checked={backupChecked}
                                        onChange={() => setBackupChecked(!backupChecked)}
                            ...
                            <div className="p-3 border border-[#e6e1db] dark:border-[#3d3326] rounded-lg flex items-center justify-between gap-3">
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs font-bold text-[#f49d25] mt-1">+ ₹1,100</p>
                                </div>
                                <button className="bg-[#f49d25]/20 hover:bg-[#f49d25] text-[#f49d25] hover:text-white p-1 rounded transition-colors">
                            ...
                            <div className="p-3 border border-[#e6e1db] dark:border-[#3d3326] rounded-lg flex items-center justify-between gap-3">
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs font-bold text-[#f49d25] mt-1">+ ₹500</p>
                                </div>
                                <button className="bg-[#f49d25]/20 hover:bg-[#f49d25] text-[#f49d25] hover:text-white p-1 rounded transition-colors">
                                    <span className="material-symbols-outlined text-sm">add</span>
                                </button>
                    ...
                    <section className="sticky top-24 bg-white dark:bg-[#2a2218] rounded-xl border-t-4 border-[#f49d25] shadow-xl overflow-hidden">
                        <div className="p-6 space-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-2xl font-black text-[#f49d25]">₹51,848</span>
                            </div>
                            <p className="text-[10px] text-center text-[#8a7960]">Inclusive of all taxes and automated travel credits</p>
                        </div>
                        <button className="w-full bg-[#f49d25] hover:bg-[#f49d25]/90 text-white font-bold py-5 flex items-center justify-center gap-2 text-lg transition-all group">
                            Proceed to Payment
