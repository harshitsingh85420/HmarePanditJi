...
export default function BookingSummaryPage() {
    ...
    return (
        <main className="flex-1 max-w-[1200px] mx-auto w-full px-4 py-8 bg-[#f8f7f5] dark:bg-[#221a10] min-h-screen">
            {/* Progress Stepper */}
            <div className="flex flex-col gap-3 mb-8">
                <div className="flex gap-6 justify-between items-end">
                    <div>
                        <h1 className="text-[#181511] dark:text-white text-3xl font-black leading-tight tracking-[-0.033em]">
                            Review your Booking
                        </h1>
                        <p className="text-[#8a7960] dark:text-gray-400 text-base font-normal">
                            Wedding Puja at Delhi NCR
                        </p>
                    </div>
                ...
                <div className="rounded-full bg-[#e6e1db] dark:bg-[#3d3326] h-2 overflow-hidden">
                    <div className="h-full bg-[#f49d25]" style={{ width: "33.33%" }}></div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <section className="bg-white dark:bg-[#2a2218] p-6 rounded-xl border border-[#e6e1db] dark:border-[#3d3326] shadow-sm">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-start py-2">
                                ...
                                <span className="font-semibold dark:text-white">₹21,000</span>
                            </div>
                            {/* Samagri */}
                            <div className="flex justify-between items-start py-2">
                                <div>
                                ...
                                <span className="font-semibold dark:text-white">₹12,500</span>
                            </div>
                            {/* Logistics Breakdown */}
                ...
                <div className="lg:col-span-4 space-y-6">
                            ...
                            <div className="p-3 border-2 border-[#f49d25]/20 bg-[#f49d25]/5 rounded-lg flex items-center justify-between gap-3">
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setAddons({ ...addons, backup: e.target.checked })
                                        }
                                        className="sr-only peer"
                                        type="checkbox"
                                    />
                                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#f49d25]"></div>
                                </label>
                            </div>
                    ...
                    <section className="sticky top-24 bg-white dark:bg-[#2a2218] rounded-xl border-t-4 border-[#f49d25] shadow-xl overflow-hidden">
                        <div className="p-6 space-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                <span className="text-xl font-black text-[#181511] dark:text-white">
                                    Grand Total
                                </span>
                                <span className="text-2xl font-black text-[#f49d25]">
                                    ₹
                                    {(
                                        46499 -
                                        4650 +
                            ...
                            <p className="text-[10px] text-center text-[#8a7960]">
