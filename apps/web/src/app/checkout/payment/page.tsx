                ...
                <div className="lg:col-span-4 flex flex-col gap-6 order-2 lg:order-1">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-start">
                                <div className="flex flex-col">
                                    <span className="text-lg font-medium text-slate-900 dark:text-white leading-tight">Maha Mrityunjaya Jaap</span>
                                    <span className="text-base text-slate-500">11 Pandits | 3 Days Ritual</span>
                                </div>
                                <span className="text-lg font-semibold text-slate-900 dark:text-white">₹71,868</span>
                            </div>
                            <div className="flex justify-between items-start">
                                <div className="flex flex-col">
                                    <span className="text-lg font-medium text-slate-900 dark:text-white leading-tight">Backup Pandit Coverage</span>
                                    <span className="text-base text-slate-500 text-green-600">Premium Protection</span>
                                </div>
                                <span className="text-lg font-semibold text-slate-900 dark:text-white">₹8,000</span>
                            </div>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="flex items-center gap-3 p-4 bg-blue-50 dark:bg-[#135bec]/10 rounded-lg border border-blue-100 dark:border-[#135bec]/20">
                            ...
                            <div>
                                <p className="text-lg font-bold text-slate-900 dark:text-white leading-none">PCI DSS Compliant</p>
                                <p className="text-base text-slate-500 mt-1">Bank-grade 256-bit encryption</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-500/10 rounded-lg border border-green-100 dark:border-green-500/20">
                            ...
                            <div>
                                <p className="text-lg font-bold text-slate-900 dark:text-white leading-none">₹1 Crore Insurance</p>
                                <p className="text-base text-slate-500 mt-1">Event protection guarantee</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-8 flex flex-col gap-6 order-1 lg:order-2">
                    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                        <div className="p-6 border-b border-slate-100 dark:border-slate-800">
                            ...
                            <p className="text-slate-500 text-lg mt-1">Transaction is encrypted and secure</p>
                        </div>
                        <div className="p-6 space-y-8">
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-4">
                                    ...
                                    >
                                        ...
                                        <div>
                                            <p className="text-lg font-bold text-slate-900 dark:text-white">HDFC Bank •••• 4242</p>
                                            <p className="text-base text-slate-500">Exp: 12/28</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    {[
                                        ...
                                        >
                                            ...
                                            <span className="text-base font-bold mt-2 text-slate-700 dark:text-slate-300 group-hover:text-[#135bec]">{upi.name}</span>
                                        </button>
                                    ))}
                                </div>
                            </div>
                                ...
                                <div className="animate-in fade-in slide-in-from-top-4 duration-300">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="col-span-2">
                                            <label className="block text-lg font-medium text-slate-700 dark:text-slate-300 mb-1">Card Number</label>
                                        ...
                                        <div className="col-span-1">
                                            <label className="block text-lg font-medium text-slate-700 dark:text-slate-300 mb-1">Expiry Date</label>
                                        ...
                                        <div className="col-span-1">
                                            <label className="block text-lg font-medium text-slate-700 dark:text-slate-300 mb-1">CVV</label>
                            ...
                            <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700 cursor-pointer hover:border-[#135bec] transition-colors">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-lg font-bold text-slate-900 dark:text-white">Net Banking</span>
                                </div>
                        ...
                        <div className="p-6 bg-slate-50 dark:bg-slate-800/30 border-t border-slate-100 dark:border-slate-800">
                            <div className="space-y-3 mb-6">
                                <label className="flex items-start gap-3 cursor-pointer">
                                    ...
                                    <span className="text-lg text-slate-600 dark:text-slate-400">I agree to the <Link href="#" className="text-[#135bec] hover:underline">Terms of Service</Link> and <Link href="#" className="text-[#135bec] hover:underline">Privacy Policy</Link>.</span>
                                </label>
                                <label className="flex items-start gap-3 cursor-pointer">
                                    <input className="mt-1 rounded border-slate-300 text-[#135bec] focus:ring-[#135bec]" type="checkbox" defaultChecked />
                                    <span className="text-lg text-slate-600 dark:text-slate-400">I acknowledge the <Link href="#" className="text-[#135bec] hover:underline">Cancellation & Refund Policy</Link> for religious services.</span>
                                </label>
                            </div>
                            <button
                    ...
                    <div className="flex items-center justify-center gap-6 text-slate-400 py-4">
                        <div className="flex items-center gap-1">
                            ...
                            <span className="text-base">24/7 Support: 1800-PANDIT-01</span>
                        </div>
                        <div className="flex items-center gap-1">
                            <span className="material-symbols-outlined text-lg">mail</span>
                            <span className="text-base">support@hmarepanditji.com</span>
                        </div>
                    </div>
                </div>
            </div>
