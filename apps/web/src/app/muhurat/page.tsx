...
<p className="text-base font-bold text-primary uppercase tracking-widest mb-2">Pro Tip</p>
...
<button className="px-4 py-3.5 rounded-md text-lg font-medium bg-white dark:bg-background-dark shadow-sm">Month</button>
<button className="px-4 py-3.5 rounded-md text-lg font-medium text-slate-500">Week</button>
</div>
</div>
<div className="grid grid-cols-7 gap-px bg-slate-200 dark:bg-white/10 rounded-xl overflow-hidden">
<div className="bg-slate-50 dark:bg-background-dark/50 py-3 text-center text-base font-bold uppercase tracking-wider text-slate-500">Sun</div>
<div className="bg-slate-50 dark:bg-background-dark/50 py-3 text-center text-base font-bold uppercase tracking-wider text-slate-500">Mon</div>
<div className="bg-slate-50 dark:bg-background-dark/50 py-3 text-center text-base font-bold uppercase tracking-wider text-slate-500">Tue</div>
<div className="bg-slate-50 dark:bg-background-dark/50 py-3 text-center text-base font-bold uppercase tracking-wider text-slate-500">Wed</div>
<div className="bg-slate-50 dark:bg-background-dark/50 py-3 text-center text-base font-bold uppercase tracking-wider text-slate-500">Thu</div>
<div className="bg-slate-50 dark:bg-background-dark/50 py-3 text-center text-base font-bold uppercase tracking-wider text-slate-500">Fri</div>
<div className="bg-slate-50 dark:bg-background-dark/50 py-3 text-center text-base font-bold uppercase tracking-wider text-slate-500">Sat</div>
...
<span className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/20 text-primary font-bold">3</span>
<div className="mt-2 flex flex-col gap-1">
<div className="bg-primary/10 text-[10px] px-1.5 py-2 rounded text-primary font-medium">4 Pujas</div>
</div>
</div>
...
<div className="bg-white dark:bg-background-dark min-h-[100px] p-2 border-r border-b border-slate-100 dark:border-white/5">
<span className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/20 text-primary font-bold">6</span>
<div className="mt-2 flex flex-col gap-1">
<div className="bg-primary/10 text-[10px] px-1.5 py-2 rounded text-primary font-medium">2 Pujas</div>
</div>
</div>
...
<div className="bg-white dark:bg-background-dark min-h-[100px] p-2 border-r border-b border-slate-100 dark:border-white/5">
<span className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/20 text-primary font-bold">11</span>
<div className="mt-2 flex flex-col gap-1">
<div className="bg-primary/10 text-[10px] px-1.5 py-2 rounded text-primary font-medium">5 Pujas</div>
</div>
</div>
...
<span className="flex items-center justify-center w-12 h-12 rounded-full bg-primary text-background-dark font-bold">16</span>
<div className="mt-2 flex flex-col gap-1">
<div className="bg-primary/30 text-[10px] px-1.5 py-2 rounded text-background-dark dark:text-primary font-bold">8 Pujas Today</div>
</div>
</div>
...
<div className="bg-white dark:bg-background-dark min-h-[100px] p-2 border-r border-b border-slate-100 dark:border-white/5">
<span className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/20 text-primary font-bold">18</span>
<div className="mt-2 flex flex-col gap-1">
<div className="bg-primary/10 text-[10px] px-1.5 py-2 rounded text-primary font-medium">3 Pujas</div>
</div>
</div>
...
<span className="flex items-center justify-center w-12 h-12 rounded-full bg-primary/20 text-primary font-bold">25</span>
<div className="mt-2 flex flex-col gap-1">
<div className="bg-primary/10 text-[10px] px-1.5 py-2 rounded text-primary font-medium">6 Pujas</div>
</div>
</div>
...
<span className="text-base bg-primary/20 text-primary px-4 py-3 rounded-full font-bold uppercase tracking-wider">Auspicious</span>
</div>
...
<button className="w-full py-2.5 rounded-lg border border-primary text-primary font-bold text-lg hover:bg-primary hover:text-background-dark transition-all">
                                Search Pandits
                            </button>
</div>
<div className="p-4 rounded-xl border border-slate-100 dark:border-white/10 hover:border-primary/50 transition-colors bg-slate-50/50 dark:bg-white/5 group">
...
<button className="w-full py-4 bg-slate-100 dark:bg-white/10 rounded-xl text-slate-500 font-medium text-lg flex items-center justify-center gap-2">
