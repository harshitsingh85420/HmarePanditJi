...
export default function CorporateInvoicePage({ params }: { params: { id: string } }) {
    ...
    return (
        <div className="bg-[#f6f6f8] dark:bg-[#101622] font-sans text-slate-800 dark:text-slate-200 min-h-screen flex flex-col">
            <style jsx global>{`
                @media print {
                    body {
                            ...
                            <div className="w-full md:w-1/2 md:pr-12 mb-8 md:mb-0">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc list-inside text-xs text-slate-500 dark:text-slate-400 space-y-1">
                                        ...
                                        <li>
                                            Late payments may incur a 2% monthly interest
                                            charge.
                                        </li>
                                        <li>
                                            Dakshina component is exempt from GST under
                                            Notification No. 12/2017.
                                        </li>
                                        <li>
                                            Disputes must be raised within 3 days of
                            ...
                            <div className="w-full md:w-1/2 md:pl-8">
                                <div className="space-y-3 text-sm">
                                    ...
                                    <div className="flex justify-between items-center pt-4 border-t-2 border-slate-200 dark:border-slate-700 mt-2">
                                        ...
                                        <span className="font-bold text-2xl text-[#0f49bd]">
                                            ₹83,900.00
                                        </span>
                                    </div>
                                ...
                                <div className="mt-12 text-right">
                                    {/* Abstract signature line */}
                                    <div className="inline-block relative">
                                        <img
                                            className="w-32 h-12 object-contain opacity-60 mix-blend-multiply dark:mix-blend-lighten mb-1"
                                    ...
                                    <p className="text-[10px] text-slate-500">
                                        For HmarePanditJi Logistics Pvt Ltd
                                    </p>
                                </div>
                            </div>
                        </div>
