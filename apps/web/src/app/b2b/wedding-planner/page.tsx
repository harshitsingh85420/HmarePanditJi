        ...
        <div className="bg-[#f6f6f8] dark:bg-[#101622] font-sans text-slate-900 dark:text-slate-100 min-h-screen flex h-screen overflow-hidden">
            ...
            <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col flex-shrink-0">
                <div className="p-6 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg font-bold leading-none text-[#1152d4]">
                            HmarePanditJi
                        </h1>
                ...
                <nav className="flex-1 px-4 space-y-1 mt-4 overflow-y-auto">
                    <a
                        className="flex items-center gap-3 px-5 py-2 rounded-lg bg-[#1152d4]/10 border-l-4 border-[#1152d4] text-[#1152d4] font-medium"
                        href="#"
                    >
                    ...
                    <a
                        className="flex items-center gap-3 px-5 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
                        href="#"
                    >
                ...
                <div className="p-4 border-t border-slate-200 dark:border-slate-800 mt-auto">
                    <a
                        className="flex items-center gap-3 px-5 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors mb-4"
                        href="#"
                    >
            ...
            <main className="flex-1 flex flex-col overflow-y-auto min-w-0">
                ...
                <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-8 flex items-center justify-between sticky top-0 z-10 shrink-0">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden md:flex items-center bg-slate-100 dark:bg-slate-800 px-5 py-3.5 rounded-lg border border-slate-200 dark:border-slate-700">
                            <span className="material-symbols-outlined text-slate-400 text-xl">
                                search
                            </span>
                            <input
                                className="bg-transparent border-none focus:ring-0 text-lg w-64 text-slate-800 dark:text-white placeholder-slate-400"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className="text-base font-bold text-green-600 bg-green-100 dark:bg-green-900/30 dark:text-green-400 px-4 py-2 rounded-full">
                                    +12%
                                </span>
                            </div>
                        ...
                        <div className="p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className="text-base font-bold text-slate-500 bg-slate-100 dark:bg-slate-800 px-4 py-2 rounded-full">
                                    Stable
                                </span>
                            </div>
                            <p className="text-slate-500 dark:text-slate-400 text-lg font-medium">
                        ...
                        <div className="p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className="text-base font-bold text-red-600 bg-red-100 dark:bg-red-900/30 dark:text-red-400 px-4 py-2 rounded-full">
                                    Action Required
                                </span>
                            </div>
                            <p className="text-slate-500 dark:text-slate-400 text-lg font-medium">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                        ...
                        <div className="xl:col-span-2 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                            <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center">
                                ...
                                <button className="text-lg font-semibold text-[#1152d4] hover:underline">
                                    View All
                                </button>
                            </div>
                            <div className="overflow-x-auto">
                                <table className="w-full text-left">
                                    <thead className="bg-slate-50 dark:bg-slate-800/50 text-slate-500 text-base uppercase tracking-wider">
                                        <tr>
                                    ...
                                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                        <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <span className="px-4.5 py-3 rounded-full text-[10px] font-bold uppercase bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-400">
                                                    Confirmed
                                                </span>
                                            </td>
                                        </tr>
                                        <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <span className="px-4.5 py-3 rounded-full text-[10px] font-bold uppercase bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-400">
                                                    Pending
                                                </span>
                                            </td>
                                        </tr>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-6">
                                ...
                                <div className="space-y-3">
                                    <button className="w-full text-left p-3 rounded-lg border border-slate-100 dark:border-slate-800 hover:border-[#D4AF37] transition-all group bg-slate-50 dark:bg-slate-800">
                                        <p className="text-lg font-semibold group-hover:text-[#D4AF37] text-slate-700 dark:text-slate-200">
                                            Vedic Vivah Special
                                        </p>
                            ...
                            <div className="bg-[#1152d4] text-white rounded-xl shadow-lg p-6 relative overflow-hidden">
                                <div className="relative z-10">
                                    ...
                                    <button className="bg-white text-[#1152d4] text-base font-bold py-2 px-4 rounded-lg hover:bg-blue-50 transition-colors">
                                        Generate Batch
                                    </button>
                                </div>
