                ...
                <div className="px-6 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="w-12 h-12 rounded-lg bg-[#0f49bd] flex items-center justify-center text-white font-bold text-lg">
                                H
                            </div>
                        ...
                        {/* Main Nav */}
                        <nav className="hidden md:flex items-center gap-6 text-lg font-medium text-gray-500 dark:text-gray-400">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative hidden lg:block">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2 w-64 bg-gray-100 dark:bg-gray-800 border-none rounded-lg text-lg focus:ring-2 focus:ring-[#0f49bd]/50 text-gray-900 dark:text-white placeholder-gray-500"
                            />
                        </div>
                        {/* Notifications */}
                ...
                <div className="mb-6">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 flex flex-col xl:flex-row gap-4 justify-between items-start xl:items-center">
                        ...
                        <div className="flex flex-wrap items-center gap-3 w-full xl:w-auto">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    readOnly
                                    value="Nov 24 - Nov 26"
                                    className="pl-9 pr-8 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg text-lg text-gray-900 dark:text-gray-100 focus:ring-[#0f49bd] focus:border-[#0f49bd] w-48 transition-shadow"
                                />
                            ...
                            <div className="relative">
                                <select className="pl-3 pr-8 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg text-lg text-gray-900 dark:text-gray-100 focus:ring-[#0f49bd] focus:border-[#0f49bd] appearance-none w-40">
                        ...
                        <div className="flex flex-wrap items-center gap-3 w-full xl:w-auto justify-end">
                            <button className="flex items-center gap-2 px-4 py-2 bg-[#0f49bd]/10 hover:bg-[#0f49bd]/20 text-[#0f49bd] rounded-lg text-lg font-medium transition-colors border border-[#0f49bd]/20">
                                <span className="material-icons text-lg">download</span>
                                Bulk Itineraries
                            </button>
                            <button className="flex items-center gap-2 px-4 py-2 bg-[#ff9933]/10 hover:bg-[#ff9933]/20 text-[#a86521] dark:text-[#ff9933] rounded-lg text-lg font-medium transition-colors border border-[#ff9933]/20">
                                <span className="material-icons text-lg">calculate</span>
                                Samagri Costs
                            </button>
                            <button className="flex items-center gap-2 px-4 py-2 bg-[#0f49bd] hover:bg-[#0c3b9b] text-white rounded-lg text-lg font-medium shadow-md shadow-[#0f49bd]/20 transition-all hover:shadow-lg hover:shadow-[#0f49bd]/30">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 flex-1 flex flex-col overflow-hidden">
                    <div className="overflow-x-auto custom-scrollbar flex-1">
                        <table className="w-full text-left border-collapse">
                            <thead className="bg-gray-50 dark:bg-gray-900/50 sticky top-0 z-10 text-base uppercase text-gray-500 font-semibold tracking-wider">
                                <tr>
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-700 text-lg">
                                ...
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        ...
                                        <div className="text-base text-gray-500 font-mono mt-0.5">
                                            BK-2023-892
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        ...
                                        <div className="text-base text-gray-500">10:00 AM</div>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-base text-[#0f49bd] cursor-pointer hover:underline">
                                                    View Profile
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td className="px-6 py-4 align-middle text-center">
                                        <span className="inline-flex items-center px-4.5 py-3 rounded-full text-base font-medium bg-[#ff9933]/10 text-orange-700 dark:text-orange-400 border border-[#ff9933]/20">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
                                            ...
                                            <span className="text-base">Ready (Pt. J. Joshi)</span>
                                        </div>
                                    </td>
                                ...
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        ...
                                        <div className="text-base text-gray-500">06:00 PM</div>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        <div>
                                            <div className="font-medium text-gray-900 dark:text-gray-200">
                                    ...
                                    <td className="px-6 py-4 align-middle text-center">
                                        <span className="inline-flex items-center px-4.5 py-3 rounded-full text-base font-medium bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-800">
                                            At Venue
                                        </span>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
                                            ...
                                            <span className="text-base">Not Required</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 align-middle text-right">
                                        <button className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <tr className="bg-red-50/50 dark:bg-red-900/10 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors group">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        ...
                                        <div className="text-base text-gray-500">09:30 AM</div>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        <div>
                                            <div className="font-medium text-gray-900 dark:text-gray-200">
                                            ...
                                            <div className="text-base text-gray-500">Gurgaon, NCR</div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        <div className="flex items-center gap-3">
                                            <div className="h-12 w-12 rounded-full bg-gray-200 flex items-center justify-center text-gray-500 text-base font-bold">
                                                Pt
                                            </div>
                                            <div>
                                                <div className="font-medium text-gray-900 dark:text-white">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        <button className="flex items-center gap-2 text-base font-medium bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded px-4 py-3 text-gray-700 dark:text-white shadow-sm hover:border-[#0f49bd] hover:text-[#0f49bd] transition-colors">
                                ...
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        ...
                                        <div className="text-base text-gray-500">02:00 PM</div>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        <div>
                                            <div className="font-medium text-gray-900 dark:text-gray-200">
                                    ...
                                    <td className="px-6 py-4 align-middle text-center">
                                        <span className="inline-flex items-center px-4.5 py-3 rounded-full text-base font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border border-blue-200 dark:border-blue-800">
                                            Assigned
                                        </span>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
                                            ...
                                            <span className="text-base">Ready (Pt. K. Trivedi)</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 align-middle text-right">
                                        <button className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        ...
                                        <div className="text-base text-gray-500">07:00 PM</div>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        <div>
                                            <div className="font-medium text-gray-900 dark:text-gray-200">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        <div className="flex items-center gap-2 text-yellow-600 dark:text-yellow-500 bg-yellow-50 dark:bg-yellow-900/10 px-4 py-3 rounded border border-yellow-200 dark:border-yellow-900/30">
                                            <span className="material-icons text-lg">
                                                warning_amber
                                            </span>
                                            <span className="text-base">Unassigned</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 align-middle text-right">
                                        <button className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <tr className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        <div>
                                            ...
                                            <div className="text-base text-gray-500">Lonavala, MH</div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        <div className="flex items-center gap-3">
                                            <div className="h-12 w-12 rounded-full bg-[#0f49bd]/10 flex items-center justify-center text-[#0f49bd] text-base font-bold">
                                                Pt
                                            </div>
                                            <div>
                                                <div className="font-medium text-gray-900 dark:text-white">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
                                            ...
                                            <span className="text-base">Ready (Pt. S. Rao)</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 align-middle text-right">
                                        <button className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <div className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            <button className="px-5 py-3 text-lg border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-300 disabled:opacity-50">
                                Previous
                            </button>
                            <button className="px-5 py-3 text-lg border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-600">
                                Next
                            </button>
                        </div>
                    </div>
