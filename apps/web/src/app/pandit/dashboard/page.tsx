...
export default function PanditDashboardPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#f8f7f6] dark:bg-[#221910] text-[#181411] dark:text-[#f8f7f6] font-sans">
                ...
                <div className="flex flex-1 justify-end gap-8 items-center">
                    <nav className="hidden md:flex items-center gap-9">
                        <Link
                            ...
                            className="text-[#f09942] text-lg font-bold leading-normal border-b-2 border-[#f09942] pb-1"
                        >
                            Home
                        </Link>
                        <Link
                            href="/pandit/bookings"
                            className="text-[#181411] dark:text-white/80 text-lg font-medium leading-normal hover:text-[#f09942] transition-colors"
                        >
                            Bookings
                        </Link>
                        <Link
                    ...
                    <div className="flex items-center gap-3">
                        <button className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-14 px-4 bg-[#f09942]/10 text-[#181411] dark:text-white text-lg font-bold leading-normal tracking-[0.015em] hover:bg-[#f09942]/20 transition-colors">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 px-4">
                    ...
                    <div className="flex items-center gap-4 bg-white dark:bg-[#221910] p-3 rounded-xl border border-[#f09942]/20 shadow-sm">
                        <div className="flex flex-col">
                            <span className="text-base uppercase font-bold text-gray-500 tracking-wider">
                                Status
                            </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 px-4 mb-8">
                    <div className="flex flex-col gap-2 rounded-xl p-6 bg-white dark:bg-gray-800 border border-[#f09942]/10 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-center justify-between">
                            <p className="text-gray-500 dark:text-gray-400 text-lg font-medium leading-normal">
                                Monthly Earnings
                            </p>
                    ...
                    <div className="flex flex-col gap-2 rounded-xl p-6 bg-white dark:bg-gray-800 border border-[#f09942]/10 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="flex items-center gap-1">
                            <span className="material-symbols-outlined text-base text-[#f09942]">
                                route
                            </span>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white dark:bg-gray-800 border-l-4 border-[#f09942] rounded-xl p-5 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            <div className="flex gap-4">
                                <div className="flex flex-col items-center justify-center min-w-[60px] h-full py-3 bg-[#f09942]/5 rounded-lg border border-[#f09942]/10">
                                    <span className="text-[#f09942] font-bold text-lg">
                                        10:00
                                    </span>
                                    <span className="text-base font-medium text-gray-500">AM</span>
                                </div>
                                <div>
                        ...
                        <div className="bg-white dark:bg-gray-800 border-l-4 border-gray-300 dark:border-gray-600 rounded-xl p-5 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                            <div className="flex gap-4">
                                <div className="flex flex-col items-center justify-center min-w-[60px] h-full py-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-100">
                                    <span className="text-gray-700 dark:text-gray-300 font-bold text-lg">
                                        04:00
                                    </span>
                                    <span className="text-base font-medium text-gray-500">PM</span>
                                </div>
                                <div>
                                    <h3 className="font-bold text-lg text-[#181411] dark:text-white">
                                        Griha Pravesh
            ...
            <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-background-dark border-t border-gray-200 dark:border-gray-800 flex justify-around py-3 px-4 z-50">
