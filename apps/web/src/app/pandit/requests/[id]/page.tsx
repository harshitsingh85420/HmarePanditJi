...
export default function BookingRequestPage({ params }: { params: { id: string } }) {
    ...
    return (
        <main className="max-w-md mx-auto min-h-screen flex flex-col bg-white dark:bg-[#1a130d] shadow-xl relative">
            {/* Header / Navigation */}
            <div className="sticky top-0 z-20 bg-white dark:bg-[#1a130d] border-b border-[#f48525]/10">
                <div className="flex items-center px-4 py-4 justify-between">
                    ...
                    <h2 className="text-lg font-bold leading-tight tracking-tight flex-1 text-center pr-10 text-[#181411] dark:text-white">
                        Booking Request
                    </h2>
                </div>
                {/* Urgent Banner */}
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-base font-bold leading-tight text-[#181411] dark:text-white">
                                        Delhi Grand Wedding
                                    </p>
                                </div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-semibold text-[#181411] dark:text-white">
                                            Dec 15 - 17
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start gap-3 pt-4 border-t border-[#e6e0db] dark:border-[#3d2c1d]">
                                <div className="bg-[#f48525]/10 p-2 rounded-lg">
                                    <span className="material-symbols-outlined text-[#f48525]">
                                        inventory_2
                                    </span>
            ...
            <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white/80 dark:bg-[#1a130d]/80 backdrop-blur-md border-t border-[#e6e0db] dark:border-[#3d2c1d] px-4 pb-8 pt-4">
                <div className="flex flex-col gap-3">
                    ...
                    <button
                        onClick={() => router.back()}
                        className="w-full bg-transparent hover:bg-red-50 dark:hover:bg-red-900/10 text-red-500 dark:text-red-400 font-bold py-3 rounded-xl transition-colors flex items-center justify-center gap-2"
                    >
