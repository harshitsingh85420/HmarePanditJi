            ...
            <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e6e0db] dark:border-[#3d2b1d] px-4 md:px-10 py-3 bg-white dark:bg-[#2d1f14] sticky top-0 z-50">
                ...
                <div className="flex flex-1 justify-end gap-8">
                    <div className="hidden md:flex items-center gap-9">
                        <Link href="/pandit/earnings" className="text-[#181411] dark:text-[#d4ccc4] text-lg font-medium leading-normal hover:text-[#f48525] transition-colors">
                            Earnings
                        </Link>
                        <Link href="/pandit/bookings" className="text-[#181411] dark:text-[#d4ccc4] text-lg font-medium leading-normal hover:text-[#f48525] transition-colors">
                            Bookings
                        </Link>
                        <Link href="/pandit/profile" className="text-[#181411] dark:text-[#d4ccc4] text-lg font-medium leading-normal hover:text-[#f48525] transition-colors">
                            Profile
                        </Link>
                        <Link href="/pandit/support" className="text-[#181411] dark:text-[#d4ccc4] text-lg font-medium leading-normal hover:text-[#f48525] transition-colors">
                            Support
                        </Link>
                    </div>
                    <div className="flex items-center gap-4">
                        <button className="hidden md:flex min-w-[84px] cursor-pointer items-center justify-center rounded-lg h-14 px-4 bg-[#f48525] text-white text-lg font-bold leading-normal hover:bg-[#f48525]/90">
                            <span>Logout</span>
                        </button>
                        <div
            ...
            <main className="flex flex-1 justify-center py-8 px-4 md:px-10 lg:px-40">
                <div className="flex flex-col max-w-[960px] flex-1">
                    <div className="flex flex-wrap gap-2 mb-4">
                        <button
                            onClick={() => router.back()}
                            className="text-[#8a7460] dark:text-[#a6917c] text-lg font-medium flex items-center gap-1 hover:text-[#f48525]"
                        >
                            <span className="material-symbols-outlined text-lg">arrow_back</span> Earnings
                        </button>
                        <span className="text-[#8a7460] dark:text-[#a6917c] text-lg font-medium">/</span>
                        <span className="text-[#181411] dark:text-[#f8f7f5] text-lg font-medium">
                    ...
                    <div className="flex flex-wrap justify-between items-end gap-3 mb-6 bg-white dark:bg-[#2d1f14] p-6 rounded-xl border border-[#e6e0db] dark:border-[#3d2b1d]">
                        <div className="flex min-w-72 flex-col gap-2">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="material-symbols-outlined text-lg text-[#f48525]">
                                    receipt_long
                                </span>
                                <p className="text-[#8a7460] dark:text-[#a6917c] text-lg font-normal">
                                    Transaction ID: TXN9876543210
                                </p>
                            </div>
                        </div>
                        <button className="flex min-w-[140px] cursor-pointer items-center justify-center rounded-lg h-14 px-4 bg-[#f5f2f0] dark:bg-[#3d2b1d] text-[#181411] dark:text-white text-lg font-bold leading-normal border border-transparent hover:border-[#f48525] transition-all">
                    ...
                    <div className="flex flex-wrap gap-4 mb-8">
                        <div className="flex min-w-[200px] flex-1 flex-col gap-2 rounded-xl p-8 bg-[#f48525] text-white shadow-lg shadow-[#f48525]/20">
                            <p className="text-white/80 text-lg font-medium uppercase tracking-wider">
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-white dark:bg-[#2d1f14]">
                                        <th className="px-6 py-4 text-[#181411] dark:text-white text-base font-bold uppercase tracking-wider">
                                            Description
                                        </th>
                                        <th className="px-6 py-4 text-[#181411] dark:text-white text-base font-bold uppercase tracking-wider text-right">
                                            Gross Amount
                                        </th>
                                        <th className="px-6 py-4 text-[#181411] dark:text-white text-base font-bold uppercase tracking-wider text-center">
                                            Deductions/Status
                                        </th>
                                        <th className="px-6 py-4 text-[#181411] dark:text-white text-base font-bold uppercase tracking-wider text-right">
                                            Net Amount
                                ...
                                <tbody className="divide-y divide-[#e6e0db] dark:divide-[#3d2b1d]">
                                    <tr className="hover:bg-[#f8f7f5] dark:hover:bg-[#221810]/30 transition-colors">
                                        <td className="px-6 py-5 text-[#181411] dark:text-white text-lg font-semibold">
                                            Dakshina
                                        </td>
                                        <td className="px-6 py-5 text-[#8a7460] dark:text-[#a6917c] text-lg text-right">
                                            ₹35,000
                                        </td>
                                        <td className="px-6 py-5 text-center">
                                            <span className="inline-flex items-center px-4.5 py-2 rounded-full text-base font-medium bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400">
                                                -15% Platform Fee
                                            </span>
                                        </td>
                                        <td className="px-6 py-5 text-[#f48525] text-lg font-bold text-right">
                                            ₹29,750
                                        </td>
                                    </tr>
                                    <tr className="hover:bg-[#f8f7f5] dark:hover:bg-[#221810]/30 transition-colors">
                                        ...
                                        <td className="px-6 py-5 text-center">
                                            <span className="text-base text-[#8a7460] dark:text-[#a6917c]">
                                                —
                                            </span>
                                        </td>
                                        <td className="px-6 py-5 text-[#f48525] text-lg font-bold text-right">
                                ...
                                <tfoot>
                                    <tr className="bg-[#f48525]/5 dark:bg-[#f48525]/10">
                                        <td
                                            className="px-6 py-4 text-[#181411] dark:text-white text-lg font-bold text-right"
                                            colSpan={3}
                                        >
                                            Total Net Payout
                                        </td>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6 p-8 bg-white dark:bg-[#2d1f14] rounded-xl border border-[#e6e0db] dark:border-[#3d2b1d]">
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-[#8a7460] dark:text-[#a6917c] text-lg">
                                Withdrawal requests are processed within 24-48 hours.
                            </p>
                        </div>
                        <div className="flex items-center gap-4 w-full md:w-auto">
                            <button className="text-[#f48525] text-lg font-bold hover:underline">
                                View Policy
                            </button>
                    ...
                    <footer className="mt-12 mb-8 text-center">
                        <div className="flex justify-center gap-6 text-[#8a7460] dark:text-[#a6917c] text-lg font-medium">
                        ...
                        <p className="mt-4 text-[#8a7460]/60 text-base">
