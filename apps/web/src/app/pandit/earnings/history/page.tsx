        ...
        <div className="flex flex-col min-h-screen bg-[#f8f6f6] dark:bg-[#221610] text-[#1e293b] dark:text-[#f1f5f9] font-sans">
            ...
            <header className="flex items-center justify-between border-b border-[#ec5b13]/10 bg-white dark:bg-[#221610] px-6 md:px-20 py-4 sticky top-0 z-50">
                <div className="flex items-center gap-4">
                    <button
                        onClick={() => router.back()}
                        className="flex items-center justify-center w-14 h-14 rounded-xl bg-[#ec5b13]/10 text-[#ec5b13] hover:bg-[#ec5b13]/20 transition-colors"
                    >
                        <span className="material-symbols-outlined">arrow_back</span>
                    </button>
                    <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-[#ec5b13]/10 text-[#ec5b13]">
                ...
                <div className="flex gap-3">
                    <button className="hidden md:flex items-center gap-2 rounded-xl h-14 px-4 bg-[#ec5b13] text-white text-lg font-bold transition-all hover:bg-[#ec5b13]/90">
                        <span className="material-symbols-outlined text-[20px]">download</span>
                        <span>Download Invoice</span>
                    </button>
                    <button className="flex md:hidden items-center justify-center rounded-xl h-14 w-14 bg-[#ec5b13] text-white">
            ...
            <main className="flex-1 px-4 md:px-20 py-8 max-w-6xl mx-auto w-full">
                ...
                <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 text-[#ec5b13] font-bold text-lg uppercase tracking-wider">
                    ...
                    <div className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-lg font-bold">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                    <div className="md:col-span-2 flex flex-col justify-center rounded-2xl p-8 bg-white dark:bg-[#1c1917] border border-[#e2e8f0] dark:border-[#292524] shadow-sm relative overflow-hidden">
                        ...
                        <p className="text-[#64748b] dark:text-[#94a3b8] text-lg font-bold uppercase tracking-widest mb-2">
                        ...
                        <div className="flex items-baseline gap-2">
                            ...
                            <span className="text-green-500 text-lg font-bold">+100% Paid</span>
                        </div>
                    ...
                    <div className="flex flex-col justify-between rounded-2xl p-6 bg-[#ec5b13]/5 border border-[#ec5b13]/20">
                        <div>
                            <p className="text-[#64748b] text-base font-bold uppercase tracking-widest mb-1">
                                Platform Fee
                            </p>
                ...
                <div className="mb-10">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <button className="text-[#ec5b13] text-lg font-bold hover:underline">
                            View Policy
                        </button>
                    </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-[#f8fafc] dark:bg-[#292524]/50">
                                    <th className="px-6 py-4 text-base font-bold uppercase tracking-wider text-[#64748b]">
                                        Description
                                    </th>
                                    <th className="px-6 py-4 text-base font-bold uppercase tracking-wider text-[#64748b]">
                                        Gross Amount
                                    ...
                                    <th className="px-6 py-4 text-base font-bold uppercase tracking-wider text-[#64748b] text-right">
                                        Net Amount
                                    </th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-[#f1f5f9] dark:divide-[#292524]">
                                ...
                                <tr className="hover:bg-[#f8fafc]/50 dark:hover:bg-[#292524]/30 transition-colors">
                                    ...
                                    <td className="px-6 py-5 text-lg font-medium">₹45,000.00</td>
                                    <td className="px-6 py-5">
                                        <span className="inline-block px-4 py-3 rounded-md bg-[#f1f5f9] dark:bg-[#292524] text-[#64748b] text-[10px] font-bold">
                                            -15% Platform Fee
                                        </span>
                                    </td>
                                ...
                                <tr className="hover:bg-[#f8fafc]/50 dark:hover:bg-[#292524]/30 transition-colors">
                                    ...
                                    <td className="px-6 py-5 text-lg font-medium">₹8,500.00</td>
                                    <td className="px-6 py-5">
                                        <span className="inline-block px-4 py-3 rounded-md bg-green-100 dark:bg-green-900/30 text-green-600 text-[10px] font-bold">
                                            100% Approved
                                        </span>
                                    </td>
                                    <td className="px-6 py-5 text-lg font-bold text-right">
                                ...
                                <tr className="hover:bg-[#f8fafc]/50 dark:hover:bg-[#292524]/30 transition-colors">
                                    <td className="px-6 py-5">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="font-bold text-lg">Travel Allowance</p>
                                                <p className="text-base text-[#94a3b8]">
                                                    Round trip to Venue
                                                </p>
                                            </div>
                                    ...
                                    <td className="px-6 py-5 text-lg font-medium">₹4,000.00</td>
                                    <td className="px-6 py-5">
                                        <span className="inline-block px-4 py-3 rounded-md bg-green-100 dark:bg-green-900/30 text-green-600 text-[10px] font-bold">
                                            Approved
                                        </span>
                                ...
                                <tr className="hover:bg-[#f8fafc]/50 dark:hover:bg-[#292524]/30 transition-colors">
                                    ...
                                    <td className="px-6 py-5 text-lg font-medium">₹2,000.00</td>
                                    <td className="px-6 py-5">
                                        <span className="inline-block px-4 py-3 rounded-md bg-green-100 dark:bg-green-900/30 text-green-600 text-[10px] font-bold">
                                            Approved
                                        </span>
                ...
                <div className="mt-12 text-center pb-12">
                    <div className="flex items-center justify-center gap-2 text-[#94a3b8] text-base font-medium">
