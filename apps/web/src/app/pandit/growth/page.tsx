            ...
            <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e5e1dc] dark:border-[#3d2c1e] px-4 md:px-10 py-4 bg-white dark:bg-[#2d1f14] sticky top-0 z-50">
                <div className="flex items-center gap-8">
                    ...
                    <nav className="hidden md:flex items-center gap-9">
                        <Link href="/pandit/dashboard" className="text-lg font-medium hover:text-[#f48525] transition-colors">
                            Dashboard
                        </Link>
                        <Link href="/pandit/bookings" className="text-lg font-medium hover:text-[#f48525] transition-colors">
                            Bookings
                        </Link>
                        <Link href="/pandit/travel" className="text-lg font-medium hover:text-[#f48525] transition-colors">
                            Travel History
                        </Link>
                        <Link href="/pandit/growth" className="text-lg font-medium text-[#f48525] border-b-2 border-[#f48525] pb-1">
                            Badges
                        </Link>
                        <Link href="/pandit/profile" className="text-lg font-medium hover:text-[#f48525] transition-colors">
                            Profile
                        </Link>
                    </nav>
                </div>
                <div className="flex flex-1 justify-end gap-6 items-center">
                    <div className="hidden lg:flex items-center bg-[#f8f7f5] dark:bg-white/10 rounded-lg h-14 px-4 w-64">
                        <span className="material-symbols-outlined text-[#8a7460] mr-2">search</span>
                        <input
                            type="text"
                            placeholder="Search milestones..."
                            className="bg-transparent border-none outline-none text-lg w-full placeholder:text-[#8a7460] dark:text-white"
                        />
                    </div>
                    <div
                ...
                <div className="flex flex-col max-w-[960px] flex-1">
                    ...
                    <div className="flex w-full flex-col gap-6 md:flex-row md:items-center p-6 bg-white dark:bg-[#2d1f14] rounded-xl shadow-sm border border-[#e5e1dc] dark:border-[#3d2c1e]">
                        <div className="relative mx-auto md:mx-0">
                            ...
                            ></div>
                            <div className="absolute bottom-0 right-0 bg-[#f48525] text-white text-[10px] font-bold px-4 py-3 rounded-full uppercase tracking-wider shadow-md">
                                Level 5
                            </div>
                        </div>
                        <div className="flex flex-col text-center md:text-left">
                            ...
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mt-1">
                                <span className="bg-[#f48525]/10 text-[#f48525] px-5 py-3 rounded-full text-lg font-semibold">
                                    Vedic Expert
                                </span>
                    ...
                    <div className="mt-10 p-6 bg-white dark:bg-[#2d1f14] rounded-xl border border-[#e5e1dc] dark:border-[#3d2c1e]">
                        <div className="flex justify-between items-end mb-4">
                            <div>
                                <h3 className="text-lg font-semibold uppercase tracking-widest text-[#8a7460] dark:text-[#c4b5a6]">
                        ...
                        <p className="mt-4 text-lg text-[#8a7460] dark:text-[#c4b5a6]">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="flex flex-col items-center gap-4 p-5 bg-white dark:bg-[#2d1f14] rounded-xl border border-[#e5e1dc] dark:border-[#3d2c1e] text-center hover:border-[#f48525] transition-colors cursor-default">
                            ...
                            <div>
                                ...
                                <p className="text-lg text-[#8a7460] dark:text-[#c4b5a6]">
                                    Traveler
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-5 bg-white dark:bg-[#2d1f14] rounded-xl border border-[#e5e1dc] dark:border-[#3d2c1e]">
                                ...
                                <div className="text-right">
                                    ...
                                    <span className="text-base font-semibold px-4 py-2 bg-green-100 text-green-700 rounded-full">
                                        Completed
                                    </span>
                                </div>
                            </div>
                            ...
                            <button className="w-full py-4 text-[#f48525] font-bold text-lg border-2 border-dashed border-[#f48525]/20 rounded-xl hover:bg-[#f48525]/5 transition-colors">
