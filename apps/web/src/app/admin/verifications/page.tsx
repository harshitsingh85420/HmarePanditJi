            ...
            <nav className="h-16 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex items-center justify-between px-6 sticky top-0 z-50">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-base text-slate-500">Centralized Operations &amp; Vetting</p>
                    </div>
                </div>
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2 px-5 py-3.5 bg-slate-100 dark:bg-slate-800 rounded-full text-lg">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="h-14 w-14 rounded-full border-2 border-[#137fec]/20 overflow-hidden">
                ...
                <aside className="w-1/4 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-y-auto">
                    <div className="p-4 border-b border-slate-200 dark:border-slate-800 sticky top-0 bg-white dark:bg-slate-900 z-10">
                        <div className="relative">
                            ...
                            <input
                                className="w-full bg-slate-100 dark:bg-slate-800 border-none rounded-lg pl-10 pr-4 py-2 text-lg focus:ring-2 focus:ring-[#137fec]"
                                placeholder="Search applications..."
                                type="text"
                            />
                        </div>
                        <div className="flex gap-2 mt-4">
                            <button className="flex-1 bg-[#137fec] text-white py-3.5 rounded text-base font-semibold">
                                PENDING (24)
                            </button>
                            <button className="flex-1 bg-slate-100 dark:bg-slate-800 py-3.5 rounded text-base font-semibold">
                                REVIEWS (12)
                            </button>
                        </div>
                    </div>
                    <div className="divide-y divide-slate-100 dark:divide-slate-800">
                        ...
                        >
                            <div className="flex justify-between items-start mb-2">
                                ...
                                <span className="text-base text-slate-500">2h ago</span>
                            </div>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-bold text-lg">Pandit Vishnu Shastri</p>
                                    <p className="text-base text-slate-500">Varanasi, Uttar Pradesh</p>
                                </div>
                            </div>
                            <div className="mt-4 flex items-center justify-between">
                                <div className="flex items-center gap-1">
                                    <span className="text-base font-medium">Risk Score:</span>
                                    <span className="text-base font-bold text-green-500">12/100</span>
                                </div>
                        ...
                        >
                            <div className="flex justify-between items-start mb-2">
                                ...
                                <span className="text-base text-slate-500">4h ago</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-14 h-14 rounded-full overflow-hidden shrink-0">
                                ...
                                <div>
                                    <p className="font-bold text-lg">Acharya Ravi Kumar</p>
                                    <p className="text-base text-slate-500">Haridwar, Uttarakhand</p>
                                </div>
                            </div>
                            <div className="mt-4 flex items-center justify-between">
                                <div className="flex items-center gap-1">
                                    <span className="text-base font-medium">Risk Score:</span>
                                    <span className="text-base font-bold text-orange-500">48/100</span>
                                </div>
                                <div className="w-16 h-1 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                        ...
                        >
                            <div className="flex justify-between items-start mb-2">
                                ...
                                <span className="text-base text-slate-500">6h ago</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-14 h-14 rounded-full overflow-hidden shrink-0">
                                ...
                                <div>
                                    <p className="font-bold text-lg">Pandit Madhav Das</p>
                                    <p className="text-base text-slate-500">Ujjain, MP</p>
                                </div>
                            </div>
                            <div className="mt-4 flex items-center justify-between">
                                <div className="flex items-center gap-1">
                                    <span className="text-base font-medium">Risk Score:</span>
                                    <span className="text-base font-bold text-red-500">82/100</span>
                                </div>
                                <div className="w-16 h-1 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                ...
                <section className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="p-6 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4 text-lg text-slate-500 mt-1">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Link href="/admin/verifications/APID-20934" className="bg-[#137fec] text-white px-4 py-2 rounded-lg text-lg font-bold shadow-md hover:bg-[#137fec]/90">
                                Full Details
                            </Link>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div className="bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-800">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <span className="px-4 py-2 bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 text-[10px] font-bold rounded uppercase">
                                        Match Found
                                    </span>
                                </div>
                                <div className="space-y-3">
                                    <div className="flex justify-between text-base py-2 border-b border-dashed border-slate-200 dark:border-slate-800">
                                    ...
                                    <div className="bg-slate-50 dark:bg-slate-800 p-3 rounded-lg flex items-center gap-3">
                                        <div className="w-16 h-14 bg-slate-200 dark:bg-slate-700 rounded flex items-center justify-center">
                                        ...
                                        <button className="text-[#137fec] text-base font-bold">
                                            VIEW
                                        </button>
                                    </div>
                                </div>
                    ...
                    <footer className="p-4 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                        <div className="flex items-center gap-4">
                            ...
                            <input
                                className="bg-slate-100 dark:bg-slate-800 border-none rounded-lg text-lg w-80 px-4 py-2 focus:ring-1 focus:ring-[#137fec]"
                                placeholder="Add a comment for the team..."
                                type="text"
                            />
                        </div>
                        <div className="flex items-center gap-3">
                            <button className="px-4 py-2 text-red-500 border border-red-500/20 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg text-lg font-bold transition-colors">
                                REJECT
                            </button>
                            <button className="px-4 py-2 text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-lg text-lg font-bold transition-colors">
                                REQUEST INFO
                            </button>
                            <button className="px-8 py-2 bg-[#137fec] hover:bg-blue-600 text-white rounded-lg text-lg font-bold shadow-lg shadow-[#137fec]/20 transition-colors">
                                APPROVE PANDIT
                            </button>
                        </div>
                    </footer>
