        ...
        <div className="bg-[#f8f6f6] dark:bg-[#1a120e] text-slate-900 dark:text-slate-100 min-h-screen font-sans">
                ...
                <div className="px-6 flex h-16 items-center justify-between gap-4">
                    <div className="flex items-center gap-8">
                        ...
                        <nav className="hidden md:flex items-center gap-6">
                            <Link
                                className="text-slate-600 dark:text-slate-400 hover:text-[#ec5b13] transition-colors text-lg font-medium"
                                href="#"
                            >
                                Dashboard
                            </Link>
                            <Link
                                className="text-[#ec5b13] text-lg font-semibold border-b-2 border-[#ec5b13] py-5"
                    ...
                    <div className="flex items-center gap-4 flex-1 justify-end">
                        <div className="relative max-w-sm w-full hidden sm:block">
                            ...
                            <input
                                className="w-full bg-slate-100 dark:bg-[#2a1e17] border-none rounded-xl pl-10 pr-4 py-2 text-lg focus:ring-2 focus:ring-[#ec5b13]/50 text-slate-900 dark:text-white placeholder:text-slate-500"
                        ...
                        <div className="h-14 w-14 rounded-full border-2 border-[#ec5b13] overflow-hidden">
            ...
            <main className="max-w-[1440px] mx-auto p-4 lg:p-6 space-y-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <div className="flex items-center gap-2 text-lg text-slate-500 mb-2">
                    ...
                    <div className="flex flex-wrap gap-4 items-center w-full md:w-auto">
                        <div className="bg-[#ec5b13]/10 dark:bg-[#ec5b13]/20 border border-[#ec5b13]/30 p-4 rounded-xl flex items-center gap-4">
                            <div className="relative flex items-center justify-center">
                                ...
                                <span className="absolute text-lg font-bold text-[#ec5b13]">
                                    94
                                </span>
                            </div>
                            <div>
                                <p className="text-base uppercase tracking-wider font-bold text-[#ec5b13]/80">
                                    Expertise Score
                                </p>
                            ...
                            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-4">
                                    <div className="bg-slate-50 dark:bg-[#1a120e] p-3 rounded-lg border border-dashed border-slate-300 dark:border-[#3d2b21]">
                                        ...
                                        <button className="w-full mt-3 py-2 bg-[#ec5b13]/10 text-[#ec5b13] text-lg font-bold rounded-lg hover:bg-[#ec5b13]/20 transition-all">
                                            View Full Scan
                                        </button>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 items-center">
                                        <span className="text-base font-bold uppercase text-slate-400">
                                            Full Name
                                        </span>
                        ...
                        <section className="bg-white dark:bg-[#2a1e17] rounded-xl border border-slate-200 dark:border-[#3d2b21] overflow-hidden">
                            <div className="p-4 border-b border-slate-200 dark:border-[#3d2b21] flex justify-between items-center bg-slate-50/50 dark:bg-[#1a120e]/20">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <span className="px-4 py-3 bg-[#ec5b13]/10 text-[#ec5b13] text-[10px] font-bold uppercase rounded">
                                        AI Verified
                                    </span>
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row h-[400px]">
                                ...
                                <div className="w-full md:w-72 bg-slate-50 dark:bg-[#1a120e] border-l border-slate-200 dark:border-[#3d2b21] flex flex-col">
                                    <div className="p-3 border-b border-slate-200 dark:border-[#3d2b21] font-bold text-base uppercase text-slate-500">
                                        AI Phonetic Notes
                                    </div>
                            ...
                            <div className="p-4 space-y-4">
                                <div className="aspect-[4/5] bg-[#f8f6f6] dark:bg-[#1a120e] rounded-lg overflow-hidden border border-slate-200 dark:border-[#3d2b21] group relative">
                                    ...
                                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                        <span className="px-4 py-2 bg-white text-black text-lg font-bold rounded-lg cursor-pointer">
                                            View High Res
                                        </span>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-green-500/5 rounded-lg border border-green-500/10">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-base font-bold text-green-600 dark:text-green-500 uppercase">
                                                Degree Verified
                                            </span>
                                        </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex gap-4">
                                        <div className="flex flex-col items-center">
                                            ...
                                            <div className="w-0.5 h-12 bg-green-500/30 my-1"></div>
                                        </div>
                                        <div>
                ...
                <div className="sticky bottom-6 left-0 right-0 z-40">
                    <div className="bg-white/80 dark:bg-[#2a1e17]/95 backdrop-blur-md border border-slate-200 dark:border-[#3d2b21] p-4 rounded-2xl shadow-2xl flex flex-col md:flex-row items-center justify-between gap-4 max-w-6xl mx-auto">
                        <div className="flex items-center gap-4">
                            <div className="h-14 w-14 bg-[#ec5b13]/10 rounded-full flex items-center justify-center text-[#ec5b13]">
