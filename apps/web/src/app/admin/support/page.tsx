...
export default function AdminSupportPage() {
    return (
        <div className="bg-[#f6f6f8] dark:bg-[#101622] text-slate-800 dark:text-slate-100 font-sans h-screen flex flex-col overflow-hidden">
            {/* Top Navigation */}
            <header className="bg-white dark:bg-[#1e293b] border-b border-slate-200 dark:border-slate-700 h-16 shrink-0 px-6 flex items-center justify-between z-20 shadow-sm">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        <button className="relative p-2 text-slate-500 hover:text-[#0f49bd] transition-colors">
                        ...
                        <div className="flex items-center gap-3 pl-4 border-l border-slate-200 dark:border-slate-700">
                            ...
                            <div
                                className="w-9 h-9 rounded-full object-cover border-2 border-white dark:border-slate-600 shadow-sm bg-cover"
                                style={{
                                    backgroundImage:
                                        "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDaPMR7k_V3ahGKm50BXggr-UCWOGkmmV1aZXy4hduragviAySDttVK4VcPQ-OMsoLrwNFZva5JPNT5epjlupQpuaYUpQJRYDsfyux1cwgEWwVADsUHUzu4xn78gw-vGyqMXmydN1JAl2Q4CDTtXUqcte2DkwNwSXWN5VZ5ykI3IFSHukH4OYAYiNaLYbZ9xU-I14QpAGxiz3BKs7kOtNVMSXgpV3i7cF3RzLkXbrEXu1BtzSq4-B8KJAfSQpMdcZVdf3rcr01GKIg')",
                                }}
                            ></div>
                        </div>
                    </div>
            ...
            <main className="flex-1 flex overflow-hidden">
                ...
                <section className="flex-1 flex flex-col min-w-0 bg-[#f6f6f8] dark:bg-[#101622] relative">
                    ...
                    <div className="flex-1 relative bg-slate-200 dark:bg-slate-900 overflow-hidden">
                        ...
                        <div className="absolute inset-0 opacity-60 bg-[#e5e7eb] dark:bg-[#1f2937]"></div>
                        <div
                            className="w-full h-full object-cover mix-blend-multiply dark:mix-blend-overlay opacity-30 dark:opacity-40 grayscale bg-cover"
                            style={{
                                backgroundImage:
                                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCLwNY028QG3E7cdJn5nfYwO_BQes3gAqeTTPof_rjTqrez4yUHOg_iAQNTRjrGlBt-h1QP4N6gsszeoR6K7Ug66PSb-NWKhElPUkwjMAgROZlqjOzaJ0kVdFuxQsWxdHCtAI-lFuPgCtlwaCJd1b0SWg5TBDGln1_23XBvpvklLpH48dQFQ7WRg4mjLjMnvQN8zD4ulVIsI4ZJ3W1H4fnEJZ4xMfQpZigUf7VIYWt_KEDqd72YCU-7Cq1CJyWrZw8S2yNZRQz2U50')",
                            }}
                        ></div>
                        ...
                        <div className="absolute inset-0 p-6 pointer-events-none">
                                ...
                                <div className="relative">
                                    <div className="w-10 h-10 bg-white dark:bg-slate-800 rounded-full shadow-lg p-1 border-2 border-green-500 flex items-center justify-center transform transition hover:scale-110">
                                        <div
                                            ...
                                            style={{
                                                backgroundImage:
                                                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBI2yUWvSvXPKZ5ufTS4tmnGB7yDYrCLz0p0YpVdnKm_P1wUdDld1YbYG1z38yheetMuL9qdM1SLa0H_x5robTmHbXqW0To9evYo_aFoN_UcqH7Xo54sMZV2VJ_m6jr-u0QkD6RgkeaCwW9GwYevAHsx1kL_fNP_C2oQ9WQCd_ULn05_kkQZk71AWGCqO-ZCCHu408Cutm15ot9Hd6z1a-PQnhAuFuj88Sq9cb0WUsDQRO1CxgMP9EZB_Mg162Ct3rH8Yek9d-3gJI')",
                                            }}
                                        ></div>
                            ...
                            <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
                                {/* Path from Stuck Pandit */}
                                <path
                                    d="M 35% 40% Q 40% 45% 50% 50%"
                                    fill="none"
                                    stroke="#ef4444"
                                    strokeDasharray="5,5"
                                    strokeWidth="3"
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <div className="bg-green-50 dark:bg-green-900/20 p-2 rounded text-center border border-green-100 dark:border-green-800/30">
                                        <div className="text-[10px] text-green-700 dark:text-green-400 mb-0.5">
                                            Backup ETA
                                        </div>
