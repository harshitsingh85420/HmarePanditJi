                    ...
                    <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
                        <div className="relative w-1/2 h-1/2">
                            ...
                            <div className="absolute top-[48%] left-[60%] flex flex-col items-center animate-bounce">
                                ...
                                <div className="mt-2 bg-white dark:bg-slate-900 px-5 py-3 rounded-full shadow-lg text-base font-bold border border-primary text-slate-900 dark:text-white whitespace-nowrap">
                    ...
                    <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                        <div className="p-6">
                            <div className="flex items-start justify-between mb-4">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        <p className="text-emerald-600 dark:text-emerald-400 text-lg font-semibold">Current Status: On Time</p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-slate-100 dark:bg-slate-800/50 p-4 rounded-xl mb-6">
                                <p className="text-slate-500 dark:text-slate-400 text-base uppercase tracking-wider font-bold mb-1">Estimated Arrival</p>
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <button className="flex items-center justify-center gap-2 text-slate-500 hover:text-primary text-lg font-medium py-2 transition-colors">
                    ...
                    <div className="relative space-y-8">
                        ...
                        <div className="relative flex gap-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="text-lg text-slate-500 dark:text-slate-400 mt-0.5">Varanasi HQ</p>
                                <p className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mt-1">4:00 PM ✓</p>
                            </div>
                        </div>
                        ...
                        <div className="relative flex gap-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="text-lg text-slate-500 dark:text-slate-400 mt-0.5">Highway Checkpoint 4</p>
                                <p className="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mt-1">8:45 PM ✓</p>
                            </div>
                        </div>
                        ...
                        <div className="relative flex gap-4">
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <p className="text-lg text-slate-500 dark:text-slate-400 mt-0.5">Distance: 42km left</p>
                                <p className="text-lg font-bold text-amber-500 mt-1">10:00 PM 🟡 (In Transit)</p>
                        ...
                        <div className="relative flex gap-4 opacity-50">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="text-lg font-medium mt-1 text-slate-400">Est. 12:15 AM</p>
                            </div>
                        </div>
