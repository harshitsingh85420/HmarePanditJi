                ...
                <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-80 bg-white rounded-xl shadow-2xl border border-slate-200 z-50 overflow-hidden">
                        ...
                        <div className="p-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-1.5 max-h-40 overflow-y-auto">
                                            {samagriItem?.customItems?.map((item, idx) => (
                                                <div
                                                    key={idx}
                                                    className="flex items-center justify-between text-lg bg-slate-50 rounded-lg px-5 py-2"
                                                >
                            ...
                            <div className="mt-4 pt-3 border-t border-slate-100 flex gap-2">
                                <button
                                    ...
                                    className="flex-1 px-5 py-2 border border-slate-200 rounded-lg text-lg font-medium text-slate-700 hover:bg-slate-50 transition-colors"
                                >
                                    Remove
                                </button>
                                <button
                                    onClick={() => setShowQuickView(false)}
                                    className="flex-1 px-5 py-2 bg-primary hover:bg-primary/90 text-white rounded-lg text-lg font-semibold transition-colors"
                                >
                                    Continue
                                </button>
                            </div>
                        ...
                        <div className="bg-amber-50 px-4 py-2 border-t border-amber-100">
                            <p className="text-base text-amber-700 flex items-center gap-1.5">
