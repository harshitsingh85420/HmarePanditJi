  ...
  (
    ...
    return (
      <button
        ...
        ${variant === "primary" ? "bg-[var(--btn-primary)] text-[var(--btn-text)] hover:bg-[var(--btn-primary-dark)]" : ""}
      ...
      >
        ...
        <span
          className={`inline-flex items-center justify-center ${loading ? "opacity-0" : "opacity-100"}`}
        >
