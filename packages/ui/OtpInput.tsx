...
export const OtpInput = ({
  ...
  return (
    <div className={`flex w-full justify-center gap-2 sm:gap-3 ${className}`}>
      {otp.map((value, index) => (
        <input
          key={index}
          ...
          className="h-11 w-10 rounded-lg border border-gray-300 bg-white text-center text-xl font-bold shadow-sm transition-colors focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500 disabled:bg-gray-100 disabled:text-gray-400 sm:h-14 sm:w-12"
