...
export const Toaster: React.FC = () => {
  ...
  return (
    <div className="pointer-events-none fixed bottom-0 right-0 z-[100] flex flex-col items-end space-y-3 p-4 sm:p-6">
      {visibleToasts.map((toast) => (
        <div
          key={toast.id}
          className="animate-toast-slide-in pointer-events-auto w-full max-w-sm transform overflow-hidden rounded-lg border border-gray-100 bg-white shadow-lg ring-1 ring-black ring-opacity-5 transition-all"
        >
          ...
          <div className="h-0.5 w-full overflow-hidden bg-gray-100">
            <div
              className={`animate-toast-progress h-full origin-left
