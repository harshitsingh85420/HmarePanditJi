...
const FEW_SHOT = [
  ...
  ["कमीशन कितना काटोगे", "दक्षिणा का 90 प्रतिशत आपका है, पंडित जी — प्लेटफ़ॉर्म केवल 10 प्रतिशत सेवा-शुल्क लेता है।"],
...
export function buildAgentSystemPrompt(lang: string, ctx: AgentContext): string {
  ...
  return [
    ...
    "",
    actions.length
      ? "उपलब्ध काम (act) — केवल इसी सूची से, और केवल तभी जब पंडित जी साफ़ वही चाह रहे हों; ज़रा भी शक हो तो act=null रखकर पूछ ले:"
