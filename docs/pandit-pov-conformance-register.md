...
| F02-02 | **Failure 1** of any voice input → speaks "माफ़ कीजिये, कृपया फिर से बोलिए।" | AUTO | 🔍 |
...
| F02-05 | Failure counter resets per field, not per session | AUTO | 🔍 |
| F02-06 | **Confirmation loop after every voice input:** "आपने कहा [X] — सही है?"; "नहीं" → re-input; "हाँ" → advance (edge #4: no silent acceptance, ever) | AUTO | 🔍 |
...
| F03-02 | Detection is announced + confirmable: "आपके शहर [X] के हिसाब से हम [भाषा] सेट कर रहे हैं…" — GPS suggestion is a **prompt, never silent auto-set** (edge #1) | AUTO | 🔍 |
...
| F04-05 | Privacy: full address + lat/long **never** in any customer-facing API response; only city/district/state public | AUTO (api contract) | 🔍 **security-grade** |
...
| F08-03 | Recording instructions delivered (मंत्रोच्चार, आसन, चेहरा साफ़) | AUTO (render) | 🔍 |
...
| ID | Requirement & test expectation | Type | Status |
|---|---|---|---|
| F11-01 | Voice script states the total covers **all** pandits' dakshina | AUTO | 🔍 |
...
| F32-05 | Auto-offline: connectivity loss → 🔴 immediately | AUTO | 🔍 (GoOnline exists — verify rule) |
...
| F43-02 | Voice input resolves to universal ID, not display string | AUTO | 🔍 |
| F43-03 | Adding a pooja/item without all enabled-language names fails validation | AUTO | ❌ |

---

## Summary counts
- **Total atomic requirements: 62** (F1: 8 · F2: 12 · F3: 6 · F4: 5 · F5: 7 · F8: 6 · F9: 4 · F10: 3 · F11: 4 · F12: 4 · F32–35: 13 · F36: 3 · F43: 3)
- Today: **✅ 8 · 🟡 7 · ❌ 30 · 🔍 17**
