# AI Test Report (Error)

**Generated:** 2026-03-23T12:58:41.160Z
**Error:** Command failed: gemini -p Find all bugs and code issues --model gemini-2.5-flash --output-format json
(node:11948) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
...
**Prompt:** Find all bugs and code issues
